...
@section('title') Approved | Denied List By Date From {{$date_from}} To {{$date_to}} @endsection
...
@section('content')
    ...
    @component('components.breadcrumb')
        ...
        @slot('title') Approved | Denied Supplier List By Date @endslot
    @endcomponent
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-title-desc"> Approved | Denied Supplier Reports are the supplier reports by the company to be part of.
                    </p>
                     <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
