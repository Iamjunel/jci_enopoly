                        ...
                        <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
                            <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                 <form action="supplier/store" method="POST" novalidate>
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="submit" name="add_supplier" class="btn btn-primary add_supplier">Save</button>
                                    </div>
                            </div>
                        </form>
                        </div>
                                                        ...
                                                        <div class="row">
                                                                    ...
                                                                    <div class="col-lg-12">
                                                                            <div class="mb-3">
                                                                                ...
                                                                                <textarea class="form-control" name="checker_notes" id="productdesc" rows="5" placeholder="Input some notes"></textarea>
                                                                            </div>
