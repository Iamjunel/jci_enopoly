...
(function ($) {
    ...
    function initSettings() {
            ...
            if (!alreadyVisited) {
                ...
                */
                if ($('body').attr('data-layout-mode') === 'dark') {
                    console.log('dark');
                    $("#light-mode-switch-dark").prop('checked', true);
                    sessionStorage.setItem("is_visited", "dark-mode-switch");
                    updateThemeSettingNew(alreadyVisited);
                } else {
                    console.log('light');
                    $("#light-mode-switch-dark").prop('checked', false);
                    sessionStorage.setItem("is_visited", "light-mode-switch");
                }
        ...
        $("#light-mode-switch-dark ").on("change", function (e) {
            updateThemeSettingNew(e.target.id);
        });
    ...
    function updateThemeSettingNew(id) {
        console.log(id);
        if ($("#light-mode-switch-dark").prop("checked") == true && (id === "light-mode-switch-dark" || id === "dark-mode-switch")) {
            $("html").removeAttr("dir");
            $("#light-mode-switch-dark ").prop("checked", true);            
            $('body').attr('data-layout-mode', 'dark');
            
            sessionStorage.setItem("is_visited", "dark-mode-switch");
        } else if ($("#light-mode-switch-dark").prop("checked") == false && (id === "light-mode-switch-dark" || id === "light-mode-switch"))
        {
            $("html").removeAttr("dir");
            $("#light-mode-switch-dark").prop("checked", false);
            $('body').attr('data-layout-mode', 'light');
