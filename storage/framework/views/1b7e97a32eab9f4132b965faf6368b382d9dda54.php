        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                <li class="menu-title" key="t-menu">Main Menu</li>
                    <li>
                        <a href="<?php echo e(route('sourcer.dashboard')); ?>" class="waves-effect">
...
<!-- Left Sidebar End --><?php /**PATH D:\Skote_v4.0.0\Laravel - ENOPOLY\Admin\resources\views/layouts/sourcer_sidebar.blade.php ENDPATH**/ ?>