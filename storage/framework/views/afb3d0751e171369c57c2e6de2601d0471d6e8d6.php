        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="index" class="logo logo-dark">
                    ...
                    <span class="logo-lg">
                        <img src="<?php echo e(URL::asset('/assets/images/enopoly.png')); ?>" alt="" height="17">
                ...
                <a href="index" class="logo logo-light">
                    ...
                    <span class="logo-lg">
                        <img src="<?php echo e(URL::asset('/assets/images/enopoly.png')); ?>" alt="" height="19">
        ...
        <div class="dropdown d-inline-block">
            <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                ...
                <img class="rounded-circle header-profile-user" src="<?php echo e(isset(Auth::user()->avatar) ? asset(Auth::user()->avatar) : asset('/assets/images/users/avatar-1.jpg')); ?>"
                    alt="Header Avatar">
                <span class="d-none d-xl-inline-block ms-1" key="t-henry"><?php echo e(ucfirst(Auth::user()->type)); ?> </span>
            ...
            <div class="dropdown-menu dropdown-menu-end">
                ...
                <form id="logout-form" action="<?php echo e(route('signout')); ?>" method="GET" style="display: none;">
                    <?php echo csrf_field(); ?>
                </form>
            </div>
        </div>
...
<?php /**PATH D:\Skote_v4.0.0\Laravel - ENOPOLY\Admin\resources\views/layouts/topbar.blade.php ENDPATH**/ ?>