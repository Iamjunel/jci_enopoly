                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        ...
                        <li><a href="dashboard-job"><span class="badge rounded-pill text-bg-success float-end" key="t-new"><?php echo app('translator')->get('translation.New'); ?></span> <span key="t-jobs"><?php echo app('translator')->get('translation.Jobs'); ?></span></a></li>
                         <li><a href="dashboard-corr" key="t-corr">Client Corr</a></li>
                    </ul>
                </li>

                <li class="menu-title" key="t-apps">Client Corr</li>
                <li>
                 ...
                 <li>
                    <a href="chat" class="waves-effect">
                        ...
                        <span key="t-chat">Reports Clients By Date</span>
                    </a>
                 </li>
                <li class="menu-title" key="t-apps">Sourcer</li>
                    <li>
                        <a href="chat" class="waves-effect">
                    ...
                    <li>
                        <a href="chat" class="waves-effect">
                            <i class="bx bxs-report"></i>
                            <span key="t-chat">Reports Prospected Supplier</span>
                        </a>
                    </li>

                <li class="menu-title" key="t-apps">Caller</li>
                    <li>
                        <a href="chat" class="waves-effect">
                            <i class="bx bxs-id-card"></i>
                            <span key="t-chat">Prospected Supplier</span>
                    ...
                    <li>
                        <a href="chat" class="waves-effect">
                            <i class="bx bxs-id-card"></i>
                            <span key="t-chat">Approved Supplier</span>
                        </a>
                    </li>
...
<!-- Left Sidebar End -->
<?php /**PATH D:\Skote_v4.0.0\Laravel - ENOPOLY\Admin\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>