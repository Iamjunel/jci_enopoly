                    ...
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        <div class="card overflow-hidden">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="p-2">
                                    <form method="POST" class="form-horizontal" action="<?php echo e(route('register.custom')); ?>" enctype="multipart/form-data">
                                        <?php echo csrf_field(); ?>
                                        <div class="mb-3">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mt-5 text-center">
                            ...
                            <div>
                                <p>Already have an account ? <a href="<?php echo e(url('login')); ?>" class="fw-medium text-primary">
                                        Login</a> </p>
                                <p>© <script>
...
<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Skote_v4.0.0\Laravel - ENOPOLY\Admin\resources\views/auth/register.blade.php ENDPATH**/ ?>