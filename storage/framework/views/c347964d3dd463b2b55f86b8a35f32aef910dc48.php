...
<?php $__env->startSection('title'); ?> <?php echo app('translator')->get('translation.Basic_Tables'); ?> <?php $__env->stopSection(); ?>
    ...
    <div class="col-xl-6">
        <div class="card">
            <div class="card-body">
                ...
                <p class="card-title-desc">Add <code>.table-bordered</code> for borders on all sides of the table and
                    cells.</p>
    ...
    <div class="col-xl-6">
        <div class="card">
            <div class="card-body">
                ...
                <p class="card-title-desc">Add <code>.table-bordered</code> & <code>.border-*</code> for colored borders
                    on all sides of the table and cells.</p>
        ...
        <div class="card">
            <div class="card-body">
                <div class="table-responsive">
                    ...
                    <p class="card-title-desc">Table cells in <code>&lt;tbody&gt;</code> inherit their alignment from
                        <code>&lt;table&gt;</code> and are aligned to the the top by default. Use the vertical align
                        classes to re-align where needed.</p>
    ...
    <div class="col-xl-6">
        <div class="card">
            <div class="card-body">
                ...
                <p class="card-title-desc"> Border styles, active styles, and table variants are not inherited by nested
                    tables.</p>
    ...
    <div class="col-xl-6">
        <div class="card">
            <div class="card-body">
                ...
                <p class="card-title-desc">A <code>&lt;caption&gt;</code> functions like a heading for a table. It helps
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Skote_v4.0.0\Laravel - ENOPOLY\Admin\resources\views/tables-basic.blade.php ENDPATH**/ ?>