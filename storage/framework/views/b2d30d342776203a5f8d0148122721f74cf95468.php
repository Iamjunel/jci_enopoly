...
<?php $__env->startSection('css'); ?>
    <!-- Plugins css -->
    <link href="<?php echo e(URL::asset('/assets/libs/bootstrap-editable/bootstrap-editable.min.css')); ?>" rel="stylesheet" type="text/css" />
...
<?php $__env->startSection('script'); ?>
    ...
    <!-- Init js-->
    <script src="<?php echo e(URL::asset('/assets/js/pages/form-xeditable.init.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Skote_v4.0.0\Laravel - ENOPOLY\Admin\resources\views/form-xeditable.blade.php ENDPATH**/ ?>