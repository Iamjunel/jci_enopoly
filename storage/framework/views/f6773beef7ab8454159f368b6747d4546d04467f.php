...
<?php $__env->startSection('title'); ?> <?php echo app('translator')->get('translation.Blog'); ?> <?php $__env->stopSection(); ?>

<?php $__env->startSection('content'); ?>

<?php $__env->startComponent('components.breadcrumb'); ?>
<?php $__env->slot('li_1'); ?> Dashboards <?php $__env->endSlot(); ?>
<?php $__env->slot('title'); ?> Blog <?php $__env->endSlot(); ?>
    ...
    <div class="col-xl-4">
        <div class="card">
            <div class="card-body">
                <div class="d-flex">
                    <div class="me-3">
                        <img src="<?php echo e(URL::asset('/assets/images/users/avatar-1.jpg')); ?>" alt="" class="avatar-sm rounded-circle img-thumbnail">
                    </div>
                            ...
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item py-3">
                                    <div class="d-flex align-items-start">
                                        <div class="me-3">
                                            <img src="<?php echo e(URL::asset('/assets/images/small/img-2.jpg')); ?>" alt="" class="avatar-md h-auto d-block rounded">
                                        </div>
                                ...
                                <li class="list-group-item py-3">
                                    <div class="d-flex align-items-start">
                                        <div class="me-3">
                                            <img src="<?php echo e(URL::asset('/assets/images/small/img-6.jpg')); ?>" alt="" class="avatar-md h-auto d-block rounded">
                                        </div>
                                        <div class="align-self-center overflow-hidden me-auto">
                                            <div>
                                ...
                                <li class="list-group-item py-3">
                                    <div class="d-flex align-items-start">
                                        <div class="me-3">
                                            <img src="<?php echo e(URL::asset('/assets/images/small/img-1.jpg')); ?>" alt="" class="avatar-md h-auto d-block rounded">
                                        </div>
                    ...
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item py-3">
                            <div class="d-flex align-items-start">
                                <div class="flex-shrink-0 me-3">
                                    <div class="avatar-xs">
                                        <img src="<?php echo e(URL::asset('/assets/images/users/avatar-2.jpg')); ?>" alt="" class="img-fluid d-block rounded-circle">
                                    </div>
                                </div>
                                <div class="flex-grow-1">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Skote_v4.0.0\Laravel - ENOPOLY\Admin\resources\views/dashboard-blog.blade.php ENDPATH**/ ?>